...
namespace Stratadox\TableLoader\Test\Integration\Shop\Fixture\Infrastructure;
...
use Stratadox\TableLoader\Test\Integration\Shop\Fixture\Reviews;
...
final class ReviewsLoader extends Loader
{
    ...
    protected function doLoad($object, string $property, $position = null): Reviews
    {
        ...
        if (!isset($this->data[get_class($object)][$id])) {
            return new Reviews;
        }
